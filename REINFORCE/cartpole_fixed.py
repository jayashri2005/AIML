...
for episode in range(EPISODES):
    ...
    # Initialize episode_loss to handle episodes without training
    episode_loss = 0.0
    ...
    print(f"Episode {episode+1}, Loss {episode_loss:.4f}, Total Reward: {total_reward}, Epsilon: {EPSILON:.4f}")
